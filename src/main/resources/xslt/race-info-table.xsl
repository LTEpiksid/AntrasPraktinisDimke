            ...
            <body>
                ...
                <div class="container">
                    ...
                    <table>
                        ...
                        <tbody>
                            <xsl:for-each select="//raceinfo">
                                <tr>
                                    <td><xsl:value-of select="id"/></td>
                                    <td><xsl:value-of select="finishTime"/></td>
                                    <td><xsl:value-of select="positionNumber"/></td>
                                    <td><xsl:value-of select="race/id"/></td>
                                    <td><xsl:value-of select="racer/id"/></td>
                                </tr>
                            </xsl:for-each>
                        </tbody>
                    </table>
